    ...
    // nvidia windows 
    {
      ...
      "params": {
        ...
        "message": [
          ...
          "{{args && args.flashattention ? 'uv pip install https://huggingface.co/cocktailpeanut/wheels/resolve/main/flash_attn-2.7.4.post1%2Bcu128torch2.7.0-cp310-cp310-win_amd64.whl' : ''}}"
        ]
      },
      "next": null
    },
